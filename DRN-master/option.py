...
parser.add_argument('--model', type=str, default='DRN-S',
                    help='model name: DRN-S | DRN-L')
parser.add_argument('--pre_train', type=str, default='./experiment/MSRN1/model/model_latest.pt',
                    help='pre-trained model directory')
parser.add_argument('--pre_train_dual', type=str, default='./experiment/MSRN1/model/dual_model_latest.pt',
...
parser.add_argument('--save', type=str, default='./experiment/MSRN1/',
